        ...
        <div >
            ...
            <div style="margin:0 auto;width:1000px;margin-top:50px;">
                ...
                <el-form-item label="教师简介">
                  <el-input type="textarea" v-model="teacherInfo.intro" style="width:500px;"></el-input>
                </el-form-item>
                <el-form-item label="详细介绍">
                  <el-input type="textarea" v-model="teacherInfo.career" style="width:500px;"></el-input>
                </el-form-item>
                <!-- 头像 -->
                ...
                <el-form-item >
                  ...
                  <!-- <el-button type="primary" @click="updateTeacher">提交修改</el-button> -->
